...
\item Colab output-folder secret: \texttt{GDRIVE\_OUTPUT\_FOLDER\_ID}.
...
\item Drive upload access: the service-account email must be shared on the destination
Drive folder identified by \texttt{GDRIVE\_OUTPUT\_FOLDER\_ID}.
