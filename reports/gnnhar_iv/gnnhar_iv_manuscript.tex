...
The notebook clones the repository branch \texttt{2026-06-01}, mounts Google Drive, runs the
full GNNHAR-IV pipeline, and writes tables, figures, metadata, and a report draft to the
Drive folder \path{/content/drive/MyDrive/GNNHAR-colab-runs/outputs}.
...
\begin{lstlisting}[language=Python,caption={Mount Google Drive in Colab.}]
from google.colab import drive
drive.mount('/content/drive')
\end{lstlisting}

\begin{lstlisting}[language=Python,caption={Clone the exact GitHub branch used in the full run.}]
import pathlib
import shutil
import subprocess
...
OUTPUT_DIR = pathlib.Path('/content/drive/MyDrive/GNNHAR-colab-runs/outputs')
...
pd.read_csv(
    '/content/drive/MyDrive/GNNHAR-colab-runs/outputs/tables/model_losses.csv'
).head(20)
\end{lstlisting}
