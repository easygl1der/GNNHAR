# Zhang-style Rolling Scale Experiment: sp500-smoke
...
- Median graph density: 0.506667
- Median graph edges: 152.0

## Result

The best model by rolling test QLIKE is `GHAR+IV` with QLIKE 0.00761157 and MSE 34.2591.
