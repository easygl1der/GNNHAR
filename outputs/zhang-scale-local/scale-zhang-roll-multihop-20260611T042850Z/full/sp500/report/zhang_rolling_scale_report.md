# Zhang-style Rolling Scale Experiment: sp500
...
- Assets selected: 449
- Valid aligned dates after HAR lags: 2021-07-19 to 2026-06-01
...
- Blocks with graph fallback: 0 / 2
- Median graph density: 0.0254385
- Median graph edges: 2558.5

## Result

The best model by rolling test QLIKE is `GHAR+IV` with QLIKE 0.00544793 and MSE 16.472.
